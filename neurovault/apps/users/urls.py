...
urlpatterns = [
    ...
    re_path(r'^login/$',        LoginView.as_view(
        ...
        name="login"),
    re_path(r'^logout/$', 
        LogoutView.as_view(template_name='registration/logout.html', next_page='/'), name="logout"),
    re_path(r'^create/$',
        create_user,
        name="create_user"),
    ...
    re_path(r'^tokens/$', PersonalTokenList.as_view(),
        name="token_list"),
    re_path(r'^tokens/new$', PersonalTokenCreate.as_view(),
        name="token_create"),
    re_path(r'^tokens/(?P<pk>\d+)/delete/$', PersonalTokenDelete.as_view(),
        name="token_delete"),

    re_path(r'^connections/$', ConnectionList.as_view(),
        name="connection_list"),
    re_path(r'^connections/(?P<pk>\d+)/revoke/$', ConnectionDelete.as_view(),
        name="connection_revoke"),

    re_path(r'^applications/$', ApplicationList.as_view(),
        name="developerapps_list"),
    re_path(r'^applications/register/$', ApplicationRegistration.as_view(),
        name="developerapps_register"),
    re_path(r'^applications/(?P<pk>\d+)/$', ApplicationUpdate.as_view(),
        name="developerapps_update"),
    re_path(r'^applications/(?P<pk>\d+)/delete/$', ApplicationDelete.as_view(),
        name="developerapps_delete"),

    re_path(r'^(?P<username>[A-Za-z0-9@/./+/-/_]+)/$',
        view_profile,
        name="profile"
        ),
]
