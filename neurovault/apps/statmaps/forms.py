...
collection_fieldsets = [
    ...
    ('IntersubjectRegistration', {'fields': [
                ...
                'resampled_voxel_size'], 
                                'legend': 'IntersubjectRegistration'}),
    ('IndividualSubjectModeling', {
            ...
            'legend': 'IndividualSubjectModeling'}),
