...
urlpatterns = patterns('',
    ...
    url(r'^images/(?P<pk>\d+)/(?P<collection_cid>\d+|[A-Z]{8})/choose_cognitive_decoder$',
        choose_cognitive_decoder,
        name="private_choose_cognitive_decoder"),
    url(r'^images/(?P<pk>\d+)/cognitive_decoder_(?P<topic_set_pk>[0-9]+)$',
        cognitive_decoder,
        name="cognitive_decoder"),
    url(r'^images/(?P<pk>\d+)/(?P<collection_cid>\d+|[A-Z]{8})/cognitive_decoder_(?P<topic_set_pk>[0-9]+)$',
        cognitive_decoder,
    ...
    url(r'^images/(?P<pk>\d+)/(?P<collection_cid>\d+|[A-Z]{8})/cognitive_decoder_json_(?P<topic_set_pk>[0-9]+)$',
        cognitive_decoder_json,
