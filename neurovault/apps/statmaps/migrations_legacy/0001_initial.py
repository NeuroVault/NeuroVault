    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(upload_to=neurovault.apps.statmaps.models.upload_to, storage=neurovault.apps.statmaps.storage.DoubleExtensionStorage(), verbose_name=b'File with the unthresholded map (.img, .nii, .nii.gz)')),
                ('add_date', models.DateTimeField(auto_now_add=True, verbose_name=b'date published')),
                ('modify_date', models.DateTimeField(auto_now=True, verbose_name=b'date modified')),
