...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Collection', fields ['private_token']
        db.create_unique(u'statmaps_collection', ['private_token'])


    def backwards(self, orm):
        # Removing unique constraint on 'Collection', fields ['private_token']
        db.delete_unique(u'statmaps_collection', ['private_token'])
    ...
    models = {
        ...
        u'statmaps.collection': {
            ...
            'private_token': ('django.db.models.fields.CharField', [], {'max_length': '8', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
