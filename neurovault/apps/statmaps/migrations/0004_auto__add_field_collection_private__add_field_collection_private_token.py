...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Collection.private'
        db.add_column(u'statmaps_collection', 'private',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Collection.private_token'
        db.add_column(u'statmaps_collection', 'private_token',
                      self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Collection.private'
        db.delete_column(u'statmaps_collection', 'private')

        # Deleting field 'Collection.private_token'
        db.delete_column(u'statmaps_collection', 'private_token')
    ...
    models = {
        ...
        u'statmaps.collection': {
            ...
            'private_token': ('django.db.models.fields.CharField', [], {'max_length': '8', 'null': 'True', 'blank': 'True'}),
