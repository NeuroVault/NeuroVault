    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ttl_file', models.FileField(verbose_name=b'Turtle serialization of NIDM Results (.ttl)', editable=False, upload_to=neurovault.apps.statmaps.models.upload_to)),
                ('provn_file', models.FileField(verbose_name=b'Provenance store serialization of NIDM Results (.provn)', editable=False, upload_to=neurovault.apps.statmaps.models.upload_to)),
                ('zip_file', models.FileField(upload_to=neurovault.apps.statmaps.models.upload_to, verbose_name=b'NIDM Results zip file')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nidm_results_zip', models.ForeignKey(to='statmaps.NIDMResults')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AlterUniqueTogether(
            name='nidmresults',
            unique_together=set([('collection', 'zip_file')]),
        ),
    ]
