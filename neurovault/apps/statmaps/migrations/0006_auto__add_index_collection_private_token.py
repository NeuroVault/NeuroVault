...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Collection', fields ['private_token']
        db.create_index(u'statmaps_collection', ['private_token'])


    def backwards(self, orm):
        # Removing index on 'Collection', fields ['private_token']
        db.delete_index(u'statmaps_collection', ['private_token'])
    ...
    models = {
        ...
        u'statmaps.collection': {
            ...
            'private_token': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '8', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
