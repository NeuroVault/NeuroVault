...
class Collection(models.Model):
    ...
    full_dataset_url = models.URLField(max_length=200, blank=True, null=True, verbose_name="Full dataset URL", help_text="Link to the full (raw) dataset the maps in this collection have been generated from (for example: \"https://openfmri.org/dataset/ds000001\")")
